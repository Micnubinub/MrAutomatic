...
public class MaterialSeekBar extends View {
    ...
    public MaterialSeekBar(Context context, int width, int height) {
        super(context);
        init(context);
        //Todo
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        scrubberPosition = getPaddingLeft() + (width - getPaddingRight() - getPaddingLeft()) * progress / (float) max;
        ...
        canvas.drawLine(getPaddingLeft(), line_pos, scrubberPosition, line_pos, paint);
